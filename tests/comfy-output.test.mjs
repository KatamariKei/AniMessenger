...
test("completed Comfy images resolve safely inside the configured output folder", () => {
  const url = new URL("http://localhost/api/images/view?filename=ANIMA_00007_.png&subfolder=CharaSMS%5CExample+Hero%5C2026-07-16&type=output");
  const resolved = resolveComfyOutputFile("C:\\ComfyUI\\output", url);
  assert.equal(resolved, path.resolve("C:\\ComfyUI\\output", "CharaSMS", "Example Hero", "2026-07-16", "ANIMA_00007_.png"));
});
