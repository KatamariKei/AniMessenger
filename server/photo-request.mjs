const photoNoun = /\b(?:photo|picture|pic|selfie|snapshot|image|shot|capture)\b/i;
...
const recentPhotoContext = /(?:\bphoto|picture|pic|selfie|snapshot|image|shot|capture|upload|camera\b|\bsend(?:ing)? it\b|\bsee (?:my|your) face\b)/i;
